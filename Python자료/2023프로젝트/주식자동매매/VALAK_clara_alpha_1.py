...
def get_current_price(code="005930"):
    ...
    return int(output_dict['stck_prpr'])
def inclination(code="005930"):
    ...
    i.append(int(output_list[5]['stck_prpr']) - int(output_list[6]['stck_prpr']))
    s = sum(i)
    result = False
    if i[0] <= 0 and i[1] <= 0 and s <= 0:
        result = True
    return result
                    ...
                    if len(symbol_list) < 1:#첫 종목 리스트 조회
                        ...
                        for sym in symbol_list:
                            ...
                            if inclination(sym):
                                ...
                                if rt[3] * 0.15 < rt[0] < rt[3] * 0.35 and rt[1] < 0 and rt[2] > 0 and rt[1] * -0.7 > rt[2]:
